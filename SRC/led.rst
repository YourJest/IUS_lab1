                              ...
                              4 ; This file was generated Tue Sep 04 14:40:40 2018
                              5 ;--------------------------------------------------------
                              6 	.module led
   ...
   0008                     332 	.ds 1
                            ...
                            383 ;	SRC/led.c:32: static unsigned char old_led = 0;   // "Видеопамять" линейки светодиодов
   2161 75 08 00            384 	mov	_old_led,#0x00
                            385 ;--------------------------------------------------------
                            386 ; Home
                            387 ;--------------------------------------------------------
                            388 	.area HOME    (CODE)
   ...
   2167                     406 _led:
                    ...
                    0000    413 	ar0 = 0x00
                    0001    414 	ar1 = 0x01
   2167 C0 09               415 	push	_bp
   2169 85 81 09            416 	mov	_bp,sp
                            417 ;	SRC/led.c:55: if( n > 7 ) return;
   216C E5 82               418 	mov	a,dpl
   216E FA                  419 	mov	r2,a
   216F 24 F8               420 	add	a,#0xff - 0x07
   2171 50 02               421 	jnc	00102$
   2173 80 32               422 	sjmp	00106$
   2175                     423 00102$:
                            424 ;	SRC/led.c:57: c = old_led;
   2175 AB 08               425 	mov	r3,_old_led
                            426 ;	SRC/led.c:59: mask <<= n;
   2177 8A F0               427 	mov	b,r2
   2179 05 F0               428 	inc	b
   217B 74 01               429 	mov	a,#0x01
   217D 80 02               430 	sjmp	00113$
   217F                     431 00111$:
   217F 25 E0               432 	add	a,acc
   2181                     433 00113$:
   2181 D5 F0 FB            434 	djnz	b,00111$
   2184 FA                  435 	mov	r2,a
                            436 ;	SRC/led.c:61: if( on )
   2185 A8 09               437 	mov	r0,_bp
   2187 18                  438 	dec	r0
   2188 18                  439 	dec	r0
   2189 18                  440 	dec	r0
   218A E6                  441 	mov	a,@r0
   218B 60 05               442 	jz	00104$
                            443 ;	SRC/led.c:62: c |= mask;
   218D EA                  444 	mov	a,r2
   218E 42 03               445 	orl	ar3,a
   2190 80 05               446 	sjmp	00105$
   2192                     447 00104$:
                            448 ;	SRC/led.c:64: c &= ~mask;         
   2192 EA                  449 	mov	a,r2
   2193 F4                  450 	cpl	a
   2194 FA                  451 	mov	r2,a
   2195 52 03               452 	anl	ar3,a
   2197                     453 00105$:
                            454 ;	SRC/led.c:66: write_max( SV, c );     
   2197 C0 03               455 	push	ar3
   2199 C0 03               456 	push	ar3
   219B 90 00 07            457 	mov	dptr,#0x0007
   219E 12 21 BD            458 	lcall	_write_max
   21A1 15 81               459 	dec	sp
   21A3 D0 03               460 	pop	ar3
                            461 ;	SRC/led.c:68: old_led = c;
   21A5 8B 08               462 	mov	_old_led,r3
   21A7                     463 00106$:
   21A7 D0 09               464 	pop	_bp
   21A9 22                  465 	ret
                            466 ;------------------------------------------------------------
                            ...
                            474 ;	-----------------------------------------
   21AA                     475 _leds:
   21AA AA 82               476 	mov	r2,dpl
                            477 ;	SRC/led.c:89: write_max( SV, on );     
   21AC C0 02               478 	push	ar2
   21AE C0 02               479 	push	ar2
   21B0 90 00 07            480 	mov	dptr,#0x0007
   21B3 12 21 BD            481 	lcall	_write_max
   21B6 15 81               482 	dec	sp
   21B8 D0 02               483 	pop	ar2
                            484 ;	SRC/led.c:91: old_led = on;
   21BA 8A 08               485 	mov	_old_led,r2
   21BC 22                  486 	ret
                            487 	.area CSEG    (CODE)
                            488 	.area CONST   (CODE)
                            489 	.area XINIT   (CODE)
