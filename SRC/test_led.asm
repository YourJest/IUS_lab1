...
;--------------------------------------------------------
	.globl _main
	.globl _second_animation
	.globl _first_animation
	.globl _delay
	.globl _SPR0
	.globl _SPR1
	.globl _CPHA
...
;j                         Allocated to stack - offset 5
;------------------------------------------------------------
;	SRC/test_led.c:34: void delay ( unsigned long ms )
;	-----------------------------------------
;	 function delay
;	-----------------------------------------
_delay:
	...
	add	a,#0x08
	mov	sp,a
;	SRC/test_led.c:38: for( j = 0; j < ms; j++ )
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	clr	a
...
00105$:
	...
	subb	a,r5
	jnc	00109$
;	SRC/test_led.c:40: for( i = 0; i < 50; i++ );
	mov	r0,_bp
	inc	r0
	clr	a
	mov	@r0,a
